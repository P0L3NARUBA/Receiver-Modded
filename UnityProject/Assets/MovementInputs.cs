...
public partial class @MovementInputs: IInputActionCollection2, IDisposable
{
    ...
    private List<IMagazineActions> m_MagazineActionsCallbackInterfaces = new List<IMagazineActions>();
    ...
    public struct MagazineActions
    {
        ...
        public void AddCallbacks(IMagazineActions instance)
        {
            if (instance == null || m_Wrapper.m_MagazineActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_MagazineActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IMagazineActions instance)
        {
            @InsertRound.started -= instance.OnInsertRound;
            @InsertRound.performed -= instance.OnInsertRound;
            @InsertRound.canceled -= instance.OnInsertRound;
        ...
        public void RemoveCallbacks(IMagazineActions instance)
        {
            if (m_Wrapper.m_MagazineActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IMagazineActions instance)
        {
            foreach (var item in m_Wrapper.m_MagazineActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_MagazineActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
